...
public final class ModCellItems {
    ...
    public static final DeferredHolder<Item, ModCellItem> ITEM_CELL_INFINITY = ITEMS.register("white_dwarf_cell_singularity", () -> new ModCellItem(TIER_INFINITY, Integer.MAX_VALUE, AEKeyType.items()));
    ...
    public static final DeferredHolder<Item, ModCellItem> FLUID_CELL_INFINITY = ITEMS.register("neutron_star_reservoir_singularity", () -> new ModCellItem(TIER_INFINITY, Integer.MAX_VALUE, AEKeyType.fluids()));
