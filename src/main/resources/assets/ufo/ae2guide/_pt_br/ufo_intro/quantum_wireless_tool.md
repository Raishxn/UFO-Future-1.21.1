...
1. Clique com o botão direito no bloco Quantum Pattern Hatch ou na [Quantum Interface](quantum_interface.md) para selecionar a origem.
2. Clique na face de entrada de uma máquina para criar o vínculo. Clique novamente na mesma face para removê-lo.
3. Shift+botão direito na origem alterna entre local e wireless. Também é possível usar o botão na tela.
...
O alcance padrão é 32 blocos por origem. Ajuste na UI da hatch/interface. Consulte [Rede e Bônus Wireless](quantum_wireless_buffs.md).
