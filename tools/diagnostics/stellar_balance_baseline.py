...
print('Multiplicadores verificados em `StellarEnergyMath.effectiveCost` e no controller: Safe ×2,5 energia; OC ×10 energia e avanço ×5; Safe+OC ×25 energia. O fuel tem multiplicadores distintos e não está incluído nesta tabela.\n')
...
for path in sorted((ROOT / 'src/generated/resources/data/ufo/recipe/stellar_simulation').glob('*.json')):
    ...
    for mode, numerator, denominator, speed in [('Normal', 1, 1, 1), ('Safe', 5, 2, 1), ('OC', 10, 1, 5), ('Safe+OC', 25, 1, 5)]:
